...
import { signInGoogle, signInCredential } from "@/server/auth";
      ...
      <CardContent>
        <div className="flex flex-col gap-4 mb-3">
          <Button variant="outline" className="w-full">
            <i className='bx bxl-facebook-square text-xl text-blue-600'></i>
            Login with Facebook
          </Button>
          <Button onClick={signInGoogle} type="submit" variant="outline" className="w-full">
            <i className='bx bxl-google text-xl text-orange-600'></i>
            Login with Google
          </Button>
        </div>
